...
export const ProductsPage = () => {
  ...
  const [batchFormState, setBatchFormState] = useState<NewProductData>({
    nome: "",
    descricao: "",
    valor: 0,
    empresaId: "",
  ...
  const handleAddProductToBatch = () => {
    if (
      batchFormState.nome.trim() &&
      batchFormState.descricao.trim() &&
      batchFormState.valor > 0
    ) {
  ...
  const handleRemoveFromBatch = (indexToRemove: number) => {
    setBatchProducts(
      batchProducts.filter((_, index) => index !== indexToRemove)
    );
  };
              ...
              <form onSubmit={handleAddProduct} className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewData({ ...newData, descricao: e.target.value })
                    }
                    min={50}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    step="0.01"
                    value={newData.valor === 0 ? "" : newData.valor}
                    onChange={(e) =>
                      setNewData({
                        ...newData,
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <p className="font-semibold">
                    {(p.valor || 0).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })}
                  </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  step="0.01"
                  value={editingProduct.valor === 0 ? "" : editingProduct.valor}
                  onChange={(e) =>
                    setEditingProduct({
                      ...editingProduct,
                      valor: Number(e.target.value) || 0,
      ...
      <Dialog open={isBatchAddOpen} onOpenChange={setIsBatchAddOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Preencha os dados e adicione produtos à lista. Quando terminar,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
            ...
            <div className="space-y-4 p-4 border rounded-lg">
              ...
              <div>
                ...
                <Input
                  id="batch-descricao"
                  value={batchFormState.descricao}
                  onChange={(e) =>
                    setBatchFormState({
                      ...batchFormState,
                      descricao: e.target.value,
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  step="0.01"
                  value={batchFormState.valor === 0 ? "" : batchFormState.valor}
                  onChange={(e) =>
                    setBatchFormState({
                      ...batchFormState,
                      valor: Number(e.target.value) || 0,
            ...
            <div className="space-y-2 p-4 border rounded-lg max-h-[400px] overflow-y-auto">
              <h3 className="font-semibold text-lg">
                Lista para Adicionar ({batchProducts.length})
              </h3>
